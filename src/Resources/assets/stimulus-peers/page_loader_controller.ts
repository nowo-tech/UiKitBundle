/**
 * Optional Stimulus peer — full-page loader overlay.
 *
 * Prefer kit IIFE `nowo-ui-page-loader.js` for simple show/hide.
 * This peer adds min-visible timing, same-origin link interception, and leave animation.
 *
 * Identifier: `page-loader`
 * Overlay: target `overlay` or `[data-nowo-ui-page-loader]`
 */
